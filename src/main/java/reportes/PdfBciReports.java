...
public class PdfBciReports {
    ...
    public static String getTestName3() {
        String hk = new Object(){}.getClass().getEnclosingMethod().getName();
    ...
    public static String getTestName2() {
    ...
    public static Paragraph setTestName() {
        ...
        PdfBciReports pf = new PdfBciReports();
        paragraph.add(pf.getTestName());
    ...
    public static Paragraph setReleaseName() {
        ...
        paragraph.add(" URL: ");
        paragraph.setFont(normalFont);
        //paragraph.add(AppDriver.getDriver().getCurrentUrl());
        paragraph.add("hjgjhsgdhjgdsfhjgd");
        paragraph.setSpacingAfter(5.0F);
        return paragraph;
    }
    ...
    public static void createTitlePage() {
        ...
        try {
            document.newPage();
            Image image = Image.getInstance("src/main/java/reportes/logo2.jpg");
            image.setAlignment(1);
            image.scaleAbsolute(350.0F, 250.0F);
            ...
            parrafo.setFont(normalFont);
            String url="";
            if(DriverContext.getDriver().getCurrentUrl().length()>20){
                url=DriverContext.getDriver().getCurrentUrl().substring(0,20);
            } else {
    ...
    public static void createPDF() {
        ...
        fontPASSED.setColor(Color.GREEN);
        fontFAILED.setColor(Color.RED);
        //MyColor = new Color(255, 235, 59);
        fontWARNING.setColor(Color.YELLOW);
        startDate = new Date();
